...
namespace CommLib
{
    ...
    {
        //日期/时间格式
        public const string NJT_DATETIME_FMT_SHORT = "yyyy-MM-dd";
        public const string NJT_DATETIME_FMT_DATE_HM = "yyyy-MM-dd HH:mm";
        public const string NJT_DATETIME_FMT_FULL = "yyyy-MM-dd HH:mm:ss";
        public const string NJT_DATETIME_FMT_TIME = "HH:mm:ss";
        public const string NJT_DATETIME_FMT_HM = "HH:mm";
        public const string NJT_DATETIME_FMT_YM = "yyyy-MM";
        public const string NJT_DATETIME_FMT_FULL_TIME = "yyyy-MM-dd HH:mm:ss.fff";
        ...
        {
            return datetime.ToString(NJT_DATETIME_FMT_YM);
        }
        ...
        {
            return datetime.ToString(NJT_DATETIME_FMT_SHORT);
        }
        ...
        {
            return datetime.ToString(NJT_DATETIME_FMT_DATE_HM);
        }
        ...
        {
            return datetime.ToString(NJT_DATETIME_FMT_FULL);
        }
        ...
        {
            return datetime.ToString(NJT_DATETIME_FMT_FULL_TIME);
        }
        ...
        {
            return datetime.ToString(NJT_DATETIME_FMT_TIME);
        }
        ...
        {
            return datetime.ToString(NJT_DATETIME_FMT_HM);
        }
