    ...
    */
    ...
    public class FileHelper
    {
        ...
        public static void ZipFile(string sourcePath, string destPath)
        {
            ...
            FileHelper.ZipFile(sourcePath, zipedPath, zipedFileName);
        }
        ...
        public static void ZipFile(string FileToZip, string ZipedPath, string ZipedFileName = "", int BlockSize = 1024 * 1024 * 5, int CompressionLevel = 5,  bool IsEncrypt = false)
        {
            //如果文件没有找到，则报错
