...
this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null,Type  TTType=null
        ...
        public static DataTable QueryDT(
#if CSHARP30
 this IDbConnection cnn, string sql, object param, IDbTransaction transaction, bool buffered, int? commandTimeout, CommandType? commandType
#else
 this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null, Type TTType = null
...
)
        {
            ...
            try
            {
                ...
                DataTable dt = new DataTable("dapperDT");
                dt.Load(reader);
        ...
        public static void QueryRawDataReader(
#if CSHARP30
 this IDbConnection cnn, Action<IDataReader> datahandler,string sql, object param, IDbTransaction transaction, bool buffered, int? commandTimeout, CommandType? commandType
#else
this IDbConnection cnn, Action<IDataReader> datahandler, string sql, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null, Type TTType = null
#endif
)
        {
            var identity = new Identity(sql, commandType, cnn, typeof(DapperRow), param == null ? null : param.GetType(), null);
